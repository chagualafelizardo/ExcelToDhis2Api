...
def send_data_to_dhis2(data_values):
    ...
    # # Ele vai buscar a data atual, vamos colocar uma data pre-definida
    period = "202505"  # Ou use o período atual: datetime.now().strftime("%Y%m")
    ...
    payload = {
        ...
        "dataValues": [{
            **dv,
            "attributeOptionCombo": "HllvX50cXC0"  # Adiciona o AOC a cada dataValue
